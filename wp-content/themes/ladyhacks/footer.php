...
<script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.js"></script>
	...
	<!-- HELLO -->
		<?php 
			...
			echo "<div class='contact-form'>$form</div>";
			if( !empty($location) ) {
		...
		<div class='footer-container'>
			<footer class="site-footer">
				...
				<?php
					...
					// SVG logo
					echo "<p class='footer-logo'><a href='$home_url' rel='home'>$logo</a></p>";

					$dateStart = get_field('start_date', 'option');
					$dateEnd = get_field('end_date', 'option');

					// Date announcement
					echo "<p class='footer-dates'>Join us ".$dateStart." - ".$dateEnd."!</p>";

					// Social Media for LadyHacks
