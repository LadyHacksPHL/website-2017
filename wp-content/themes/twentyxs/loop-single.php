...
<?php if (TwentyXS_option('xs_adsense_code_post_top') !== '') : { ?>
<div id="xs_adsense_code_post_top"><?php echo stripslashes(TwentyXS_option('xs_adsense_code_post_top')); ?></div>
<?php } endif; ?>
...
<?php if(function_exists('wp_print')) { echo ' '; print_link(); } ?>
